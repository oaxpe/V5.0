...
CREATE TABLE IF NOT EXISTS `dendaProiektua`.`langilea` (
  ...
  PRIMARY KEY (`pertsona_pertsNan`, `denda_dendKode`, `langKode`),
...
CREATE TABLE IF NOT EXISTS `dendaProiektua`.`produktua` (
  ...
  `prodEskuragai` TINYINT NULL,
  `denda_dendKode` VARCHAR(25) NOT NULL,
  PRIMARY KEY (`prodKode`, `denda_dendKode`),
  INDEX `fk_produktua_denda1_idx` (`denda_dendKode` ASC),
  CONSTRAINT `fk_produktua_denda1`
    FOREIGN KEY (`denda_dendKode`)
    REFERENCES `dendaProiektua`.`denda` (`dendKode`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `dendaProiektua`.`kamiseta` (
  ...
  `produktua_prodKode` VARCHAR(25) NOT NULL,
  `produktua_denda_dendKode` VARCHAR(25) NOT NULL,
  PRIMARY KEY (`produktua_prodKode`, `produktua_denda_dendKode`),
  CONSTRAINT `fk_kamiseta_produktua1`
    FOREIGN KEY (`produktua_prodKode` , `produktua_denda_dendKode`)
    REFERENCES `dendaProiektua`.`produktua` (`prodKode` , `denda_dendKode`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `dendaProiektua`.`produktua_has_eskaera` (
  `produktua_prodKode` VARCHAR(25) NOT NULL,
  `produktua_denda_dendKode` VARCHAR(20) NOT NULL,
  `eskaera_eskKode` VARCHAR(25) NOT NULL,
  `eskaera_hornitzailea_hornKode` VARCHAR(25) NOT NULL,
  `prodKop` INT NOT NULL,
  PRIMARY KEY (`produktua_prodKode`, `produktua_denda_dendKode`, `eskaera_eskKode`, `eskaera_hornitzailea_hornKode`),
  INDEX `fk_produktua_has_eskaera_eskaera1_idx` (`eskaera_eskKode` ASC, `eskaera_hornitzailea_hornKode` ASC),
  INDEX `fk_produktua_has_eskaera_produktua1_idx` (`produktua_prodKode` ASC, `produktua_denda_dendKode` ASC),
...
-- -----------------------------------------------------
-- Table `dendaProiektua`.`produktua_has_salmenta`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dendaProiektua`.`produktua_has_salmenta` ;

CREATE TABLE IF NOT EXISTS `dendaProiektua`.`produktua_has_salmenta` (
  `salmenta_salmKode` VARCHAR(25) NOT NULL,
  `produktua_prodKode` VARCHAR(25) NOT NULL,
  `produktua_denda_dendKode` VARCHAR(25) NOT NULL,
  PRIMARY KEY (`salmenta_salmKode`, `produktua_prodKode`, `produktua_denda_dendKode`),
  INDEX `fk_produktua_has_salmenta_salmenta1_idx` (`salmenta_salmKode` ASC),
  INDEX `fk_produktua_has_salmenta_produktua1_idx` (`produktua_prodKode` ASC, `produktua_denda_dendKode` ASC),
  CONSTRAINT `fk_produktua_has_salmenta_salmenta1`
    FOREIGN KEY (`salmenta_salmKode`)
    REFERENCES `dendaProiektua`.`salmenta` (`salmKode`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_produktua_has_salmenta_produktua1`
    FOREIGN KEY (`produktua_prodKode` , `produktua_denda_dendKode`)
    REFERENCES `dendaProiektua`.`produktua` (`prodKode` , `denda_dendKode`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
